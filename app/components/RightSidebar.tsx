    ...
    <div className="relative w-80 h-full">
      ...
      {showScrollToBottom && (
        <button
          ...
          className="absolute bottom-6 right-6 w-10 h-10 rounded-full bg-gray-700/90 hover:bg-gray-600/90 text-white shadow-lg transition-all duration-200 flex items-center justify-center backdrop-blur-sm border border-gray-600/50"
